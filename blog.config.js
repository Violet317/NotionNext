...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '守恒', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'AI小白，厨艺爱好者，欢迎关注', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://techchenxiaoxu.top/', // 网站地址
